...
Google Colab (TensorFlow 2.20) or a compatible local Python environment is recommended.
...
- [x] Run every Python file successfully.
- [x] Save screenshots/output from each question.
- [x] Confirm the Q2 confusion-matrix result is produced during execution.
- [x] Confirm the Q4 Sobel result is produced during execution.
- [x] Push source code and README to your GitHub repository.
- [x] Confirm your student information is in this README.
- [x] Record the demonstration video using `VIDEO_SCRIPT.md`.
